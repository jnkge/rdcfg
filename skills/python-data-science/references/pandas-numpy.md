...
> Merged reference covering the pandas library (tabular data) and the NumPy library (n-dimensional arrays) for scientific computing, data science, and machine learning in Python. The Pandas section comes first, followed by the NumPy section.

---

# Part I — Pandas Best Practices
...
# Part II — NumPy Library Best Practices and Coding Standards
